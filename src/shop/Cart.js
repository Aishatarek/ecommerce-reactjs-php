        ...
        <Container>
                ...
                <tbody>
                  {cartItems.map((product) => (
                    <tr className="divcarttttt">
                      ...
                      <td>
                        <p>{product.quantity * product.price} LE</p>
                      </td>
          ...
          <div className="cartbuttons">
            <Link to="/Productss">
              ...
              <button className="btn2cart">{t("UPDATECART")}</button>
            </Link>
          </div>
          <form className="form1cart">
            <h3>{t("Addnote")}</h3>
            <textarea></textarea>
          </form>
          <Row>
            <Col lg="9" md="9" sm="12">
              <form className="form2cart">
                <h3>{t("shippingestimates")}</h3>
                <h5>{t("Taxes")}</h5>
            ...
            <Col lg="3" md="3" sm="12">
              <div className="totalll">
                ...
                <Link to="/Checkout">
                  ...
                  <button>{t("proceedcheckout")}</button>
                </Link>
              </div>
            </Col>
          </Row>
